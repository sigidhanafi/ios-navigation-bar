//
//  LargeTitleWithCustomColorViewController.swift
//  NavigationBarCustom
//
//  Created by Sigit Hanafi on 03/03/22.
//

import Foundation
import UIKit

class LargeTitleWithCustomColorViewController: UIViewController {
    private var contentScrollView = ContentScrollView()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "Large Title with custom color VC"
